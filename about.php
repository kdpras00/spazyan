...
<head>
    ...
    <title>Tentang Kami - SiPakar Motor</title>
...
<div class="container my-5">
    <div class="row align-items-center">
        <div class="col-lg-6">
            <img src="img/motor.png" class="img-fluid rounded shadow-sm" alt="Bengkel Motor">
            
        </div>
        <div class="col-lg-6">
            <h1 class="font-weight-bold mt-4 mt-lg-0">Tentang Sistem Kami</h1>
            <p class="lead" style="text-align: justify;"><strong>SiPakar Motor</strong> adalah sebuah sistem pakar berbasis web yang dirancang untuk membantu para pemilik sepeda motor dalam melakukan identifikasi awal terhadap kemungkinan kerusakan yang terjadi pada kendaraannya.</p>
            <p class="lead" style="text-align: justify;">Sistem ini bekerja dengan cara mengumpulkan gejala-gejala yang dialami oleh pengguna. Kemudian, dengan menggunakan metode inferensi **forward chaining**, sistem akan mencocokkan kumpulan gejala tersebut dengan basis pengetahuan yang telah ditanamkan untuk menyimpulkan jenis kerusakan yang paling relevan.</p>
            <hr>
            <div class="alert alert-info" style="text-align: justify;">
                <strong>Penting:</strong> Hasil diagnosa dari sistem ini bersifat sebagai panduan dan rekomendasi awal. Untuk penanganan lebih lanjut dan perbaikan yang akurat, kami sangat menyarankan Anda untuk tetap berkonsultasi dengan mekanik profesional di bengkel terpercaya.
            </div>
        </div>
    </div>
</div>
